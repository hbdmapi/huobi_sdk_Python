...
sys.path.append('../..')
from huobi.coin_swap.rest.market import Market
...
class TestRestMarket(unittest.TestCase):
    ...
    def test_get_depth(self):
        result = self.api.get_depth(
            {"contract_code": "btc-usd", "type": "step0"})
        logger.info(result)
        self.assertEqual('ok', result['status'])
    ...
    def test_get_kline(self):
        result = self.api.get_kline(
            {"contract_code": "btc-usd", "period": "1min", "size": 10})
        logger.info(result)
        self.assertEqual('ok', result['status'])
    ...
    def test_get_history_trade(self):
        result = self.api.get_history_trade(
            {"contract_code": "btc-usd", "size": 2000})
        logger.info(result)
        self.assertEqual('ok', result['status'])
    ...
    def test_get_insurance_fund(self):
        result = self.api.get_insurance_fund(
            {"contract_code": "btc-usd", "page_index": 2, "page_size": 100})
        logger.info(result)
        self.assertEqual('ok', result['status'])
    ...
    def test_get_his_open_interest(self):
        result = self.api.get_open_interest(
            {"contract_code": "btc-usd", "period": "60min", "size": 100, "amount_type": 1})
        logger.info(result)
        self.assertEqual('ok', result['status'])
    ...
    def test_get_elite_account_ratio(self):
        result = self.api.get_elite_account_ratio(
            {"contract_code": "btc-usd", "period": "5min"})
        logger.info(result)
        self.assertEqual('ok', result['status'])
    ...
    def test_get_historical_funding_rate(self):
        result = self.api.get_historical_funding_rate(
            {"contract_code": "btc-usd", "page_index": 2, "page_size": 50})
        logger.info(result)
        self.assertEqual('ok', result['status'])

    def test_get_liquidation_orders(self):
        result = self.api.get_liquidation_orders(
            {"contract_code": "btc-usd", "trade_type": 0, "create_date": 90, "page_index": 2, "page_size": 50})
        logger.info(result)
        self.assertEqual('ok', result['status'])
    ...
    def test_get_premium_index_kline(self):
        result = self.api.get_premium_index_kline(
            {"contract_code": "btc-usd", "period": "1min", "size": 100})
        logger.info(result)
        self.assertEqual('ok', result['status'])
    ...
    def test_get_basis(self):
        result = self.api.get_basis(
            {"contract_code": "btc-usd", "period": "1min", "basis_price_type": "close", "size": 100})
        logger.info(result)
        self.assertEqual('ok', result['status'])

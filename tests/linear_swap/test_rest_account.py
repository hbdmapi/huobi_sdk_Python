...
class TestRestAccount(unittest.TestCase):
    ...
    def test_master_sub_transfer(self):
        result = self.api.master_sub_transfer(
            {"sub_uid": "33333366", "asset": "usdt", "from_margin_account": "USDT", "to_margin_account": "usdt", "amount": 1, "type": "master_to_sub"})
        logger.info(result)
        self.assertEqual('ok', result['status'])
